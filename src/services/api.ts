...
// `??` only catches null/undefined, so an env var set to "" (present-but-blank
// in .env / EAS) would slip through and point requests at the wrong origin
// (e.g. the Metro dev server). Treat blank values as absent and fall back.
